...
* **Participate in the AWS First Cloud AI Journey Kickoff event**: Grasp project regulations, internal culture, and network with members of the technical team.
* **Successfully set up a personal AWS account**: Update payment methods and configure budget alerts (AWS Budgets for the AWS Free Tier account) to serve learning, research, and familiarization with the AWS Console & CLI.
...
| :---: | :--- | :---: | :---: | :--- |
| **Mon** | - Attend the AWS First Cloud AI Journey Kickoff event <br> - Network and connect with FCJ members <br> - Research and note down rules, regulations, and corporate culture at the internship workplace | 17/04/2026 | 17/04/2026 | |
| **Tue** | - Research the overview of AWS and its pricing models <br> - Take an initial look at core service groups: *Compute, Storage, Networking, Database, ...* | 18/04/2026 | 18/04/2026 | [AWS Cloud Journey](https://cloudjourney.awsstudygroup.com/) |
| **Wed** | - Register a personal AWS Free Tier account <br> - Set up billing and configure AWS Budgets to prevent unexpected charges <br> - Execute AWS Cloud Explorer tasks on the Console to receive AWS Activate Credits | 20/04/2026 | 20/04/2026 | [AWS Cloud Journey](https://cloudjourney.awsstudygroup.com/) |
| **Thu** | - Get familiar with the AWS Management Console interface <br> - Install and configure AWS CLI on the personal computer (*Access Key, Secret Key, Default Region*) <br> - Hands-on: Execute basic AWS CLI commands to check resources | 21/04/2026 | 21/04/2026 | [AWS Cloud Journey](https://cloudjourney.awsstudygroup.com/) |
| **Fri** | - Grasp basic Amazon EC2 services: *Instance categories, AMI (Amazon Machine Image), EBS (Elastic Block Store), Elastic IP* <br> - Learn about security methods and SSH connection from a workstation to EC2 | 22/04/2026 | 22/04/2026 | [AWS Cloud Journey](https://cloudjourney.awsstudygroup.com/) |
| **Sat** | - **Practical Technical Lab Deployment**: <br>&emsp; + Provision a complete EC2 instance in practice <br>&emsp; + Create and attach an additional EBS volume <br>&emsp; + Connect via SSH and manage resources concurrently via Console & CLI | 23/04/2026 | 23/04/2026 | [AWS Cloud Journey](https://cloudjourney.awsstudygroup.com/) |
